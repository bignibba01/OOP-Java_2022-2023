...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
        final Product p1 = new ProductImpl("p1", 100); // new ProductImpl("p1", 100);
        final Product p2 = new ProductImpl("p2", 30); // new ProductImpl("p2", 30);
        final Product p3 = new ProductImpl("p3", 10); // new ProductImpl("p3", 10);
        final Warehouse warehouse = new WareHouseImpl(); // new WarehouseImpl();
